...
export const TAG_COLORS = [
  ...
  { name: 'blue', label: 'Sapphire Blue', bg: '#0b1e4a', border: '#2563eb', text: '#bfdbfe' },
  { name: 'teal', label: 'Teal Mint', bg: '#042f2e', border: '#0d9488', text: '#99f6e4' },
  { name: 'orange', label: 'Sunset Orange', bg: '#431407', border: '#ea580c', text: '#fed7aa' },
  { name: 'pink', label: 'Neon Pink', bg: '#500724', border: '#db2777', text: '#fbcfe8' },
